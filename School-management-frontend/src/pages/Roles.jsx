...
import { 
  ShieldCheck, Users, UserCog, Search, Filter, 
...
const ROLE_CONFIG = {
  ...
  'teacher': { label: 'Teacher', color: 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400', icon: Users },
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-[28px] font-bold text-gray-800 dark:text-white tracking-tight flex items-center gap-3">
            <UserCog className="w-8 h-8 text-teal-500" />
            Roles & Permissions
          </h1>
          <p className="text-gray-500 dark:text-slate-400 mt-1">Manage user access levels and system roles.</p>
        </div>
        <button 
          onClick={fetchUsers}
