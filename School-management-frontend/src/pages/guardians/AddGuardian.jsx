  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-[28px] font-bold text-gray-800 dark:text-white tracking-tight transition-colors duration-300">Add New Guardian</h1>
      </div>
      ...
      <div className="bg-white dark:bg-slate-800 p-8 rounded-[15px] shadow-[0_2px_15px_-3px_rgba(0,0,0,0.02)] border border-gray-100/50 dark:border-slate-700 transition-colors duration-300">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 dark:border-slate-700 flex justify-end transition-colors duration-300">
            <button type="submit" className="px-6 py-2.5 bg-teal-500 text-white font-medium rounded-lg hover:bg-teal-600 shadow-md transition">Save Guardian Info</button>
          </div>
        </form>
      </div>
    </div>
